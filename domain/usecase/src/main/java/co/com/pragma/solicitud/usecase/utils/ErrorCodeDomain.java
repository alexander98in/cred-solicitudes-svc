...
public enum ErrorCodeDomain {
    ...
    APPLICATION_CHANGE_STATUS("CRED-6005", "Solo se pueden actualizar solicitudes en estado 'Pendiente de revisión'"),
    APPLICATION_CONFLICT_CHANGE_STATUS("CRED-6006", "La solicitud cambió de estado por otro proceso, intente de nuevo"),
